...
public class ListDisplay extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        String path = Environment.getExternalStorageDirectory().toString() + "/Voice Recorder";
...
//        listAdapter.add("Missed Lecutre 1");
//        listAdapter.add("Missed Lecutre 2");
//        listAdapter.add("Missed Lecutre 3");
        ...
        lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> arg0, View arg1, int position,
                                    long arg3) {
                String fileName = Environment.getExternalStorageDirectory().getAbsolutePath().toString() + "/Voice Recorder/"+(String)arg0.getItemAtPosition(position);
